...
# 初始化 OpenAI 客户端
client = OpenAI(
    api_key="sk-90a6d11b53c34ea68d63a11ff7368bdf",
...
def test_judge_position():
    ...
    position_info = (
"""
化州市政务服务和数据管理局,1160554,基础设施股一级科员,11605542557002 ,从事电子政务外网基础设施建设等工作,综合管理类职位,1,本科,学士,,工学(B08),,否,否,,茂名
"""
    )

    # 用户提示
    user_prompt = "我是物理系的，只有本科学位，基层工作经历， 不是应届生，不是党员"
